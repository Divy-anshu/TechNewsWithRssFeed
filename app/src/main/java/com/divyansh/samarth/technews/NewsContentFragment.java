...
public class NewsContentFragment extends Fragment {
    ...
    public NewsContentFragment(String url) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final NewsContentFragment.FetchFeedTask fetchFeedTask = new NewsContentFragment.FetchFeedTask();
    ...
    private class FetchFeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                // Fill RecyclerView
                FetchNewsAdapter adapter = new FetchNewsAdapter(getActivity(), newsItemArrayList);
